...
class NoteFile(models.Model):
    """ An experiment in Desktop Search

    TODO:
        - semantic index of all files and all sentences within a directory tree
        - convert 300 float fields to postgres float arrays or json bfield and annoy index.
    """
...
class Sentence(models.Model):
    ...
    note = models.ForeignKey(NoteFile, on_delete='cascade')
...
def load_csv_model(csv_path='/midata/private/journal/sentences.csv',
                   model=Sentence,
                   related_model=NoteFile):
    """ Only works for the Sentence table and related NoteFile table """
